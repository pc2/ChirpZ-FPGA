 ...
 */
fpga_t fftfpgaf_c2c_chirp2d_bram_v2(const unsigned num, const float2 *inp, float2 *out, const bool inv, const unsigned batch){
  ...
  */
  ...
  status = clEnqueueTask(queue16, kernel_mult1, 0, NULL, NULL);
