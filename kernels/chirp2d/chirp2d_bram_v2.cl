...
channel float2 chanintransposeStore[POINTS]; 
...
kernel void transposeStore(
  ...
  for(int step = 0; step < ((count * DEPTH) + DEPTH); step++){
    float2x8 data, data_out;
    if (step < (count * DEPTH)) {
      data.i0 = read_channel_intel(chanintransposeStore[0]);
      data.i1 = read_channel_intel(chanintransposeStore[1]);
      data.i2 = read_channel_intel(chanintransposeStore[2]);
      data.i3 = read_channel_intel(chanintransposeStore[3]);
      data.i4 = read_channel_intel(chanintransposeStore[4]);
      data.i5 = read_channel_intel(chanintransposeStore[5]);
      data.i6 = read_channel_intel(chanintransposeStore[6]);
      data.i7 = read_channel_intel(chanintransposeStore[7]);
    } else {
      data.i0 = data.i1 = data.i2 = data.i3 = 
                data.i4 = data.i5 = data.i6 = data.i7 = 0;
    }
